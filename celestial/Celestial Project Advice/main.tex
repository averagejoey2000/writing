...
\noindent Z Keystrokes: \keystroke{RCL}\keystroke{3}\keystroke{SIN}\keystroke{\textdiv}\keystroke{(}\keystroke{RCL}\keystroke{1}\keystroke{COS}\keystroke{\texttimes}\keystroke{RCL}\keystroke{2}\keystroke{TAN}\keystroke{\textminus}\keystroke{RCL}\keystroke{1}\keystroke{SIN}\keystroke{\texttimes}\keystroke{RCL}\keystroke{3}\keystroke{COS}\keystroke{)}\keystroke{=}\keystroke{\nth{2}}\keystroke{TAN}\\
\noindent Hc Keystrokes: \keystroke{RCL}\keystroke{1}\keystroke{COS}\keystroke{\texttimes}\keystroke{RCL}\keystroke{2}\keystroke{COS}\keystroke{\texttimes}\keystroke{RCL}\keystroke{3}\keystroke{COS}\keystroke{+}\keystroke{RCL}\keystroke{1}\keystroke{SIN}\keystroke{\texttimes}\keystroke{RCL}\keystroke{2}\keystroke{SIN}\keystroke{=}\keystroke{\nth{2}}\keystroke{SIN}
\section{Scheduling}
...
Stars get harder to see, but the horizon becomes easier to sight.
    ...
    \item In the Afternoon, you can do the same thing as the morning and take a mirror azimuth or a Sun LOP.
	    Maybe you'll get lucky and shoot the moon during the day to have a \nth{4} LOP.
    \item \texttt{Sunset.
	    Observe amplitude.
    Planets Available.}
...
Effective sight planning is also crucial. Consider studying Bowditch's chapter on "Sight Planning".\pnotecite[vol 1, p. 308]{Bowditch}.
...
Apply the shade filters to your sextant, and set the altitude to 0\textdegree0.0'.
...
The best method for reducing error in a running fix is to average together multiple observations, particularly those of the latter observing session, to improve the accuracy of the LOP. \pvolcite{2}[p. 311]{Bowditch} 
\end{quotation}
...
When you go inside to check your notes and start your calculations, you find that your second observation of Mirfak is different from the \nth{1} and \nth{3} by about 9 degrees, so you discard that sight.
